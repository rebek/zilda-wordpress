	 ...
	 class TIE_FLICKR_PHOTOS extends WP_Widget {
		...
		public function widget( $args, $instance ){
			...
			?>
				...
				<a target="_blank" href="https://www.flickr.com/photos/<?php echo esc_attr( $instance['flickr_id'] )?>/" class="button dark-btn fullwidth"><?php esc_html_e( 'Follow us on Flickr', TIELABS_TEXTDOMAIN ) ?></a>
		...
		public function form( $instance ){
			...
			<p>
				...
				<small><a href="<?php echo esc_url( 'http://www.idgettr.com' ); ?>" target="_blank"><?php esc_html_e( 'Find your ID at idGettr', TIELABS_TEXTDOMAIN ); ?></a></small>
			</p>
