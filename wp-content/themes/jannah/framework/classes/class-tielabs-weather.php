...
if( ! class_exists( 'TIELABS_WEATHER' )){
	...
	class TIELABS_WEATHER {
		...
		private function show(){
			...
			if( ! is_array( $weather_data ) ) return;
			...
			if( empty( $this->atts['compact'] ) ){ ?>
				...
				<div id="tie-weather-<?php echo $this->city_slug ?>" class="weather-wrap <?php echo $is_animated ?>">
					...
					<div class="weather-icon-and-city">
						...
						<div class="weather-desc"><?php echo $today->weather[0]->description; ?></div>
					</div>
					...
					<div class="weather-todays-stats">
						...
						<?php } ?>
							...
							<div class="weather_humidty">
								...
								<span class="screen-reader-text"><?php esc_html__('humidity:', 'jannah') ?></span> <?php echo $today->main->humidity ?>%
							</div>

							<div class="weather_wind">
								<span aria-hidden="true" class="tie-icon-wind"></span>
								<span class="screen-reader-text"><?php esc_html__('wind:', 'jannah') ?></span> <?php echo $today->wind->speed .' '. $speed_text ?></div>
						</div>
			...
			// Display the weather | Comapct LAYOUT
				...
				<div class="tie-weather-widget <?php echo $is_animated ?>" title="<?php echo $today->weather[0]->description ?>">
