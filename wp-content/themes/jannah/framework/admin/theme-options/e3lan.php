	...
	foreach( $theme_ads as $ad => $name ){
		...
		tie_build_theme_option(
			array(
				...
				'id'     => $ad,
				'type'   => 'checkbox',
				'toggle' => '#'.$ad.'_title-item, #'.$ad.'_title_link-item, #'.$ad.'_img-item, #'.$ad.'_posts_number-item, #'.$ad.'_url-item, #'.$ad.'_alt-item, #'.$ad.'_tab-item, #'.$ad.'_nofollow-item, #' .$ad. '_adsense-item, #'.$ad.'-adrotate-options',
			));
